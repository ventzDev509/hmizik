...
import TablePlayListe from "./TableListe";
            ...
            >
                ...
                <div className=" bg-neutral-900 ">
                    ...
                    >
                        ...
                        <div className="max-w-7xl mx-auto px-6 pt-12 pb-12 z-10 relative">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="flex items-center gap-2"
                                            style={{ color: textColor }}
                                        >
                                            <div className="w-8 h-8 flex items-center justify-center rounded-full bg-green-500 text-black font-bold"></div>
                                            <span
                                                style={{ color: textColor }}
                                                className="text-sm text-white/80">{PLAYLIST.provider} · {PLAYLIST.totalSongs} songs, {PLAYLIST.totalDuration}</span>
                                        </div>
                                    </div>
