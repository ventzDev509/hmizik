  ...
  return (
    <div className="bg-[#121212] min-h-screen overflow-y-scroll text-white font-sans relative overflow-x-hidden">
      ...
      <main className="relative z-10 px-4 py-5 pb-44">
        ...
        {/* A. SA K'AP TRADING (Highlights) */}
        <TradingTrack />

        {/* B. DEKOUVRIT AI (Priyorite #1) */}
        <div className="my-8">
          <DiscoveryWeekly />
        </div>

        {/* C. NOUVOTE YO (Mizik ki fèk ajoute) */}
        ...
        {/* E. BANNER DEVENI ATIS (Pou kase ritm lan) */}
        <div className="my-4">
          <ArtistBanner />
        </div>
